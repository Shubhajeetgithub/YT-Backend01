...
Now create 
- **.env** file
- public directory inside which another directory called temp inside which a file called **.gitkeep**
- src directory inside which files **app.js**, **constants.js**, **index.js**
...
Inside package.json, before "main" add this line
